...
Reviewer history is evidence, not authority. Reviewer 019f56f8-79b2-7b61-bcf2-73bcf6c69cf5 returned PASS with no findings on prior head 9c6080043b49ea98f5f29e8b3fe79baf4e10a429; GitHub review 4680454951 and the required status passed, then became stale after CI remediation. Reviewer 019f576e-9981-7343-a065-555961f62853 reviewed published head 6675269e74e720f6344d563ec872ed336809f21f and returned FAIL with two P2 findings: absent-root POSIX process-group reuse and control-plane candidate drift. Reviewer 019f5a06-e5e2-7960-92fe-583d9525ba3e reviewed exact head 2cb1976d264d4c621953feb71d38af2dd041e987 and returned FAIL with two P2 findings plus one P3: terminal callback deadline bypass, abbreviated candidate-pin bypass, and stale PR check prose. The remediation isolates terminal results from arbitrary callbacks, requires exactly one fixed CLI publication, rejects Git-supported abbreviated and full candidate references, and requires live check lookup. PR #65 is already published; query its live head and checks rather than predicting them here.
