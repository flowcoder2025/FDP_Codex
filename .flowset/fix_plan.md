...
- [ ] WI-CX0050-test Worktree Isolation Verification: prove or block the A2 worktree isolation model before first Layer 2 target-project scaffold confidence claims. Expected strategy: PSC=P1, WTC=VAL, Risk=R2, ESC=E1+E3+E5+E6.
...
- WI-CX0038-docs Layer 2 Scope Code Accepted Decision: start only after the user chooses the Layer 2 project scope code rule and after WI-CX0050 repays worktree confidence debt.
