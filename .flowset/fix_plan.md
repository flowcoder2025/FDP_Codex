...
- [ ] WI-CX0055-feat First Layer 2 Dogfood Scaffold Generation: generate and validate the required Layer 2 roles under `C:\dev\FDP_Codex_Dogfood` using accepted code `FCD`, without reactivating the runner.
