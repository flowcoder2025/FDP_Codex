...
- [ ] Waiting for user decision: repair the A2 worktree execution surface so a future receiver can satisfy `docs/decisions/2026-07-08-a2-worktree-isolation-repair-gate.md`.
...
| A2 worktree isolation repair. | DQ-USER | USER | conditional | Before first Layer 2 target-project scaffold confidence claims or generalized A2/A3 expansion; gate `docs/decisions/2026-07-08-a2-worktree-isolation-repair-gate.md`. |
