...
- [ ] WI-CX0049-docs A2 Handoff Receiver Contract: define receiver success, duplicate-stop handling, repo-visible reporting, and parent-thread handback behavior before generalized A2/A3 autonomy expansion. Expected strategy: PSC=P1, WTC=SPEC, Risk=R2, ESC=E1+E3+E5+E6.
...
- WI-CX0038-docs Layer 2 Scope Code Accepted Decision: start only after the user chooses the Layer 2 project scope code rule and after WI-CX0049/WI-CX0050 repay receiver and worktree confidence debt.
