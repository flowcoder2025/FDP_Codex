...
- Candidate-bearing Issue fields are parsed across indented, lazy, tabbed, and plain Markdown field forms. Current full SHAs must match the one referenced live PR head exactly; stale full SHAs, abbreviated candidate SHAs, and ambiguous candidate cues fail closed instead of being skipped.
